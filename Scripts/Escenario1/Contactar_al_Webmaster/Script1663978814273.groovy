...
WebUI.selectOptionByLabel(findTestObject('Escenario1/Subject_Heading'), findTestData('AutomationPractice').getValue(2, 6), 
    false)

WebUI.verifyTextPresent(findTestData('AutomationPractice').getValue(2, 8), false)

WebUI.setText(findTestObject('Escenario1/Email_address'), findTestData('AutomationPractice').getValue(3, 1))

WebUI.setText(findTestObject('Escenario1/Order_reference'), findTestData('AutomationPractice').getValue(2, 3))
