...
WebUI.setText(findTestObject('Escenario3/Email_forgot_password'), findTestData('AutomationPractice').getValue(3, 1))

WebUI.click(findTestObject('Escenario3/Btn_retrieve_Password'))

WebUI.waitForElementPresent(findTestObject('Escenario3/Alerta'), 30)
