...
WebUI.verifyTextPresent(findTestData('AutomationPractice').getValue(4, 10), false)

WebUI.setText(findTestObject('Escenario3/Email'), findTestData('AutomationPractice').getValue(3, 1))

WebUI.click(findTestObject('Escenario3/Btn_Log_in'))

WebUI.verifyTextPresent(findTestData('AutomationPractice').getValue(4, 11), false)
